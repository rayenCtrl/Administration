...
public class ChefHomeFrame extends javax.swing.JFrame {

    /**
     * Creates new form ChefHomeFrame
     */
    public ChefHomeFrame() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChefHomeFrame.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
